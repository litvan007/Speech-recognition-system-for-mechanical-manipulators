...
if __name__ == '__main__':
    ...
    arr, sr = librosa.load('../test_audio_6.m4a', sr=22050)
    ...
    sound.plot_voice_range(words_grid3, title='Time of VAD splitting method with zero cross rate {:f}s (test 6)'.format(time.time() - t))
    print(mark3)
